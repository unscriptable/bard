...
define(function (require) {
	...
	NodeCollection.prototype = {
		...
		setCollection: function (data) {
			var self = this;
			this.metadata.map(data, function (model) {
				self.insertModel(model);
			});
//			this.clearModel();
//			// FIXME: We need to decide whether iterator is our primary
//			// format here.  If so, backbone CollectionAdapter.fetch needs to
//			// return an iterator
//			if(typeof iterable.forEach === 'function') {
//				var self = this;
//				iterable.forEach(function(model) {
//					self.insertModel(model);
//				});
//			} else {
//				iterator.reduce(function (self, model) {
//					self.insertModel(model);
//					return self;
